...
interface CryptInfoModalProps {
  coin: CoinInfoProps["coin2"];
}

const CryptInfoModal: React.FC<CryptInfoModalProps> = ({ coin }) => {
  return (
    <>
      <CoinInfo {...coin} withSymbol />
      <Divider />
